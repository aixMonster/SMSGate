...
public class MsgErrDeliverRequestDecoder extends AbstractTestMessageCodec<CmppDeliverRequestMessage> {
	...
	@Test
	public void testReport() throws DecoderException {
		byte[][] expecteddata = prepareReportMsgData();
		for (int i = 0; i < expecteddata.length; i++) {
			...
			while (null != (result = (CmppDeliverRequestMessage) ch.readInbound())) {
				System.out.println(result);
				CmppDeliverRequestMessage deliver = (CmppDeliverRequestMessage) result;
				Assert.assertTrue(deliver.isReport());
				CmppReportRequestMessage report = deliver.getReportRequestMessage();
				Assert.assertEquals(255, report.getSmscSequence());
				Assert.assertEquals("0000000000000123456", deliver.getLinkid());
			}
		}

	}

	private byte[][] prepareReportMsgData() throws DecoderException {

		return new byte[][] {
				// Hex.decodeHex("".toCharArray())
				// Hex.decodeHex("".toCharArray()),
				Hex.decodeHex(
						""
								.toCharArray()) };
